				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form action="${pageContext.request.contextPath}/user/searUserInfo.do"
								  method="post">
								    ...
								    <c:forEach var="user" items="${pageInfo.list}">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/updSelUserInfoById.do?id=${user.id}" class="btn bg-olive btn-xs">更新</a>
					...
					<!-- /.box-body -->
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
